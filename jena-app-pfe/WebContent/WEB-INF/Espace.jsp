 ...
 <br>
       ...
       <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded p-5">
              ...
              <span class="section-heading-lower">${ esp.appels[0]} </span>
         </h2>
         <h2 class="section-heading mb-4">     
                <span class="section-heading-upper">Description</span>
              </h2>
              <img src= "${esp.images[0]}" class="float-right">
              <p>${esp.descEltPatri}</p>
              <p>  </p>
              <p>  </p>
              <p>  </p>
             ...
             -->
              ...
              <h2 class="section-heading mb-4">
                   ...
                   <c:forEach var="appel" items="${esp.appels}">
	              <ul>
	              <li><p>${appel}</p></li>
	              </ul>
	              </c:forEach>
           ...
           <div class="col-md-6 section-md-t3" style="padding-right: 0px;">
            ...
            <div class="bg-faded p-5" style="font-size: 16.75px;">
              <h2 class="section-heading mb-4">  
	              ...
	              <p>Cet espace a été construit en: ${esp.dateConstruction} </p>
	              <p class="mb-0">La période de construction : ${esp.périodeConstruction} </p>
	              <p>            </p>
 <p class="mb-0"> </p>
            ...
            <div class="col-md-6 section-md-t3" style="padding-left: 0px;">
              ...
              <h2 class="section-heading mb-4">
                ...
                <span class="section-heading-upper">Les caractéristiques de l'espace</span>
              </h2>
              <ul>
              <li>
            ...
            <div class="bg-faded rounded p-5">
              <h2 class="section-heading mb-4">
				...
				<div id="demo" class="carousel slide" data-ride="carousel" style="padding-right: 0px;padding-top: 0px;padding-bottom: 0px;width: 400;padding-left: 260px;">
                   ...
                   <c:forEach var="image" items="${esp.images}">
